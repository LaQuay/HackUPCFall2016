...
public class SharedPreferencesManager {
    public static String CHECKBOX_SUN_KEY = "sun";
    public static String CHECKBOX_RAIN_KEY = "rain";
    public static String CHECKBOX_SNOW_KEY = "snow";
    public static String CHECKBOX_HOT_KEY = "hot";
    public static String CHECKBOX_COLD_KEY = "cold";
    public static String CHECKBOX_SUFFIX = "_checkbox";
